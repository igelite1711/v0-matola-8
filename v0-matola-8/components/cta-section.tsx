          ...
          <div className="grid gap-6 md:grid-cols-2 md:items-center md:gap-8">
            <div>
              <h2 className="mb-3 text-xl font-bold tracking-tight text-foreground sm:mb-4 sm:text-2xl md:text-3xl lg:text-4xl">
                Ready to Move Smarter? / Chitukuko Chakungichitika
              </h2>
              <p className="mb-5 text-sm text-muted-foreground sm:mb-6 sm:text-base md:text-lg">
                Join hundreds of businesses already saving on logistics with Matola. Gwiritsirani ntchito USSD, WhatsApp, kapena app.
              </p>
              <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
                <Button size="lg" asChild className="h-12 w-full gap-2 text-base font-semibold sm:h-11 sm:w-auto sm:text-sm">
                  <Link href="/register">
                    Create Account
                ...
                <Button
                  ...
                  variant="outline"
                  asChild
                  className="h-12 w-full gap-2 bg-background border-2 text-base font-semibold sm:h-11 sm:w-auto sm:text-sm"
                >
                  <a href="https://wa.me/265999123456" target="_blank" rel="noopener noreferrer">
            ...
            <div className="rounded-lg border border-border bg-card p-4 sm:rounded-xl sm:p-6">
              <h3 className="mb-3 text-sm font-semibold text-foreground sm:mb-4 sm:text-base">
                Quick Access via USSD / *384*628652#
              </h3>
              <div className="flex items-center gap-3 rounded-lg bg-secondary p-3 sm:gap-4 sm:p-4">
                ...
                <div>
                  <p className="text-xl font-bold text-primary sm:text-2xl">*384*628652#</p>
              ...
              <p className="mt-3 text-xs text-muted-foreground sm:mt-4 sm:text-sm">
                No smartphone? No problem. Book shipments, check status, and manage payments via USSD. Palibe Data? Mamembala.
              </p>
            </div>
          </div>
        </div>
